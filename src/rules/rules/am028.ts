...
/**
 * Rule that checks if an admonition has blank line or no content.
 * It also checks for blank lines in non-afm block quote.
 * @param params - filter params that is passed by markdownlint.
 * @param onError - function that is called to report an error in the file.
 */
function AM028(params: FilterParams, onError: (context: ErrorContext) => void) {
